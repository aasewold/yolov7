...
def create_dataloader(path, imgsz, batch_size, stride, opt, hyp=None, augment=False, cache=False, pad=0.0, rect=False,
                      rank=-1, world_size=1, workers=8, image_weights=False, shuffle=False, quad=False, prefix='', max_negative=1.0):
    ...
    loader = torch.utils.data.DataLoader if image_weights or shuffle else InfiniteDataLoader
